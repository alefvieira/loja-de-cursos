...
// essa function serve para adicionar na tag html o lang = "pt-br"
function adc_lang(){
  
  var addlang = document.querySelector('html');
	addlang.setAttribute('lang','pt-BR');
  return addlang;
}
adc_lang();
    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <a target="_blank"
          ...
          > 
            <h2>Por até R$97,00</h2>
            <h3>Curso de Desenho Método Fanart 3.0 </h3>
            <h4>Formato: Cursos Online, Serviços de Assinatura</h4>
            <p>O Curso de Desenho Método Fan Art 3.0 irá te ensinar a desenhar o seu personagem favorito de Anime/Mangá, mesmo que você tenha o famoso "dom" para desenhar.
            </p>         
          </a>
          ...
          >
            <h2>Por R$19,90</h2>
            <h3>E-Book Instagram para Negócios </h3>
            <h4>Formato: eBooks, Documentos</h4>
            <p>Ebook em PDF com dicas essenciais para quem deseja transformar o seu instagram em uma conta comercial, atraente e totalmente profissional, para conquistar mais seguidores, enjangamento e fortalecimento da marca da empresa de forma eficiente e estratégica.
            </p>
